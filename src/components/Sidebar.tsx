        ...
        {isOpen && (
          <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="p-3">
              <button
                onClick={onOpenDashboard}
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-panel-light transition-colors"
              >
                <LayoutGrid size={22} className="text-muted-foreground" />
                <div className="flex-1 text-left">
                  <div className="font-medium text-foreground">Dashboard</div>
                  <div className="text-xs text-muted-foreground">AI modules & tools</div>
                </div>
              </button>
            </div>

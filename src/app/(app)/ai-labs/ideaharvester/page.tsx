...
export default function IdeaHarvesterPage() {
  ...
  const handleHarvest = async () => {
    ...
    try {
      ...
      if (!data.result || !data.result.idea_spec) {
        console.warn('[IdeaHarvester] Invalid API response structure:', data);
        throw new Error('Invalid response from server - missing idea_spec');
      }
    ...
    <div className="flex-1 flex flex-col overflow-y-auto p-8">
      <div className="max-w-3xl mx-auto">
        {/* Title Section */}
            ...
            {/* Results Display */}
            {result && result.idea_spec && currentStep === 'complete' && (
              <div className="space-y-6">
                {/* Success Banner */}
